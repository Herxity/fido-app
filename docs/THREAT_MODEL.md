...
Protected assets are canonical identity links, custody history, disputes, audit records, owner verification codes, identity blind indexes, database credentials, and deployment access. Trust boundaries exist at the browser/camera, shelter staff, CloudFront/WAF, Caddy origin, FastAPI, Clerk, PostgreSQL, GitHub Actions, and SSH.

## Principal threats and controls

| Threat | Primary controls | Verification |
|---|---|---|
| Fresh account or alternate ID hides history | In-person card/likeness attestation, canonical person model, HMAC exact and fuzzy signals, alternate-document review, consolidation | Identity and red-team tests |
...
Counterfeit cards, reviewer mistakes, shelter misuse, single-node availability, and legal obligations cannot be solved solely in code. Production requires document-inspection training, staff procedures, incident response, access reviews, restore exercises, and legal/privacy sign-off.
